...
class NearbyHospitalSerializer1(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
...
class NearbyHospitalSerializer2(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
...
class InactiveHospitalSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
