...
class PoojaStoreSerializer(serializers.ModelSerializer):
...
class PoojaStoreSerializer1(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
...
class PoojaStoreSerializer2(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
...
class InactivePoojaStoreSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
