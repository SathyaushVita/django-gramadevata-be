...
from ..models import VeterinaryHospital,Register
from django.conf import settings
from ..utils import image_path_to_binary
from django.utils.timesince import timesince
from django.utils import timezone

class VeterinaryHospitalSerializer(serializers.ModelSerializer):
...
class VeterinaryHospitalSerializer1(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
    license_copy=serializers.SerializerMethodField()
...
class InactiveVeterinaryHospitalSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
    license_copy=serializers.SerializerMethodField()
