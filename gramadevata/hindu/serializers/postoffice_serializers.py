...
from ..models import VillagePostOffice,Register
...
class VillagePostOfficeSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()

    class Meta:
        model = VillagePostOffice
        fields = '__all__'
...
class VillagePostOfficeSerializer1(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()

    class Meta:
        model = VillagePostOffice
        fields = ["_id","name","branch_name","address","map_location","desc","image_location","contact_number","email_id"]
...
class InactiveVillagePostOfficeSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
