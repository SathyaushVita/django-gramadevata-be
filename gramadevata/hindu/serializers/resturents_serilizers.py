...
class TempleNearbyRestaurantSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()

    class Meta:
        model = TempleNearbyRestaurant
        fields = '__all__'
...
class TempleNearbyRestaurantSerializer1(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
    village_id=serializers.SerializerMethodField()

    class Meta:
        model = TempleNearbyRestaurant
        fields = ["_id","name","image_location","map_location","address","village_id"]
    def get_image_location(self, instance):
        filename = instance.image_location
...
class TempleNearbyRestaurantSerializer2(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
...
class InactiveRestaurantSerializer(serializers.ModelSerializer):
    image_location = serializers.SerializerMethodField()
