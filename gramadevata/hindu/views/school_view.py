...
from ..serializers import VillageSchoolSerializer,InactiveVillageSchoolSerializer
...
class VillageSchoolViewSet(viewsets.ModelViewSet):
    queryset = VillageSchool.objects.all()
    serializer_class = VillageSchoolSerializer
...
class InactiveVillageSchoolAPIView(APIView):
    ...
    def get(self, request):
        ...
        queryset = VillageSchool.objects.filter(
            status='INACTIVE',
            **filter_kwargs
        )
        ...
        serializer = InactiveVillageSchoolSerializer(queryset, many=True)

        return Response({
            "count": queryset.count(),
            "inactive_schools": serializer.data
