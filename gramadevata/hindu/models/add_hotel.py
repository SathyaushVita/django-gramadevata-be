...
from ..models import Register, TempleNearbyHotel
from ..enums import *

def generate_uuid():
    return str(uuid.uuid1())

class AddMoreHotel(models.Model):
    ...
    hotel_id = models.ForeignKey(TempleNearbyHotel,db_column='hotel_id',on_delete=models.CASCADE,related_name='additional_details',null=True,blank=True,db_index=True)
    ...
    def __str__(self):
        return f"Additional Details for {self.hotel_id.name if self.hotel_id else ''}"
