...
class TempleNearbyRestaurant(models.Model):
    ...
    temple_id = models.ForeignKey(Temple, on_delete=models.CASCADE, related_name='resturents',db_column="temple_id",null=True, blank=True,db_index=True)
    created_at = models.DateTimeField(auto_now_add=True,db_index=True)
    address = models.TextField(null=True, blank=True)
    map_location = models.CharField(max_length=255,null=True, blank=True)
    village_id = models.ForeignKey(Village, db_column='village_id', on_delete=models.SET_NULL, null=True, blank=True,related_name='resturents',db_index=True)
    ...
    event_id = models.ForeignKey(Event, on_delete=models.CASCADE, related_name='resturents', db_column="event_id", null=True, blank=True,db_index=True)
    tourism_places = models.ForeignKey(TempleNearbyTourismPlace, db_column='tourism_places', on_delete=models.SET_NULL, null=True, blank=True,related_name='resturents',db_index=True)
