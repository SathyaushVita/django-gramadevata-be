...
class VillagePostOffice(models.Model):
    ...
    village_id = models.ForeignKey(Village, db_column='village_id', on_delete=models.SET_NULL, null=True, blank=True, related_name='postoffice',db_index=True)
    temple_id = models.ForeignKey(Temple, db_column='temple_id', on_delete=models.SET_NULL, null=True, blank=True, related_name='postoffice',db_index=True)
    ...
    user_id = models.ForeignKey(Register, db_column='user_id', on_delete=models.SET_NULL, related_name='postoffice', null=True, blank=True,db_index=True)
