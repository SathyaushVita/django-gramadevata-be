...
class AddGoshalaDetails(models.Model):
    _id = models.CharField(db_column='_id', primary_key=True, max_length=45 ,default=uuid.uuid1, unique=True ,db_index=True)
    ...
    goshala_id = models.ForeignKey(Goshala, db_column='goshala_id',  on_delete=models.CASCADE, null=True, blank=True,db_index=True)
    ...
    goshala_video = models.JSONField(db_column='goshala_video', null=True, blank=True, default=list)
