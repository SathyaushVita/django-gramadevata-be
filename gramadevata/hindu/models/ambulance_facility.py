...
class AmbulanceFacility(models.Model):
    ...
    temple_id = models.ForeignKey(Temple, on_delete=models.CASCADE, related_name='ambulance_facility', db_column="temple_id", null=True, blank=True,db_index=True)
    village_id = models.ForeignKey(Village, db_column='village_id', on_delete=models.SET_NULL, null=True, blank=True, related_name='ambulance_facility',db_index=True)
